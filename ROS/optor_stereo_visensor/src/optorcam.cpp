...
#include "optor_stereo_visensor_ros/optorcam.h"
...
int EG_mode = 0;
int man_exp = 0;//设置人工增益值，建议（100-255）
int man_gain;
int auto_EG_top;
int auto_EG_bottom;
int auto_EG_des;
...
void *cam1_capture(void*)
{
    ...
    case 1://新模式1
        camera_i2c_write(1,0xAF,0x00);//AEC
        camera_i2c_write(1,0xA5,0x3A);//AEC
        camera_i2c_write(1,0xA6,0x02);//AEC
        camera_i2c_write(1,0xA8,0x00);//AEC
        //camera_i2c_write(1,0xAC,auto_EG_bottom);//AEC
        //camera_i2c_write(1,0xAD,auto_EG_top);//AEC
        camera_i2c_write(1,0xAE,14);//AEC
        break;
    case 2:
